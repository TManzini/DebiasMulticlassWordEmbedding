...
def main():
    ...
    if(args.v):
        print "Biased Analogies (0-" + str(PRINT_LIMIT) + ")"
        for score, analogy, _ in biasedAnalogies[:PRINT_LIMIT]:
            print score, analogy
    ...
    if(args.v):
        if(args.hard):
            print "="*20, "\n\n"
            print "Hard Debiased Analogies (0-" + str(PRINT_LIMIT) + ")"
            for score, analogy, _ in hardDebiasedAnalogies[:PRINT_LIMIT]:
                print score, analogy
        if(args.soft):
            print "="*20, "\n\n"
            print "Soft Debiased Analogies (0-" + str(PRINT_LIMIT) + ")"
            for score, analogy, _ in softDebiasedAnalogies[:PRINT_LIMIT]:
                print score, analogy
